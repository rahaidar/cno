...
Shopify.onCartShippingRatesUpdate=function(e,t)
{
	...
	n+=t.country,
	alert("There are "+e.length+" shipping rates available for "+n+", starting at "+Shopify.formatMoney(e[0].price)+".")
},
...
Shopify.formatMoney=function(e,t)
{
	...
	switch(a.match(o)[1])
	{
		case"amount":i=r(e,2);break;
		case"amount_no_decimals":i=r(e,0);break;
		case"amount_with_comma_separator":i=r(e,2,".",",");break;
		case"amount_no_decimals_with_comma_separator":i=r(e,0,".",",")
	}
...
Shopify.addItem=function(e,t,n)
{
	var t=t||1,
		r={
			...
			dataType:"json",
			success:function(e){"function"==typeof n?n(e):Shopify.onItemAdded(e)},
			error:function(e,t){Shopify.onError(e,t)}
		};
	jQuery.ajax(r)
},

Shopify.addItemWithProperties=function(e,t,p,n)
{
	var params = {quantity:t,id:e};
	if ("object"==typeof p) {params.properties = p;}
	var t=t||1,
		r={
			type:"POST",
			url:"/cart/add.js",
...
Shopify.addItemFromForm=function(e,t)
{
	var n={
		...
		dataType:"json",
		success:function(e){"function"==typeof t?t(e):Shopify.onItemAdded(e)},
		error:function(e,t){Shopify.onError(e,t)}
	};
	jQuery.ajax(n)
},
...
{
	jQuery.getJSON("/cart.js",function(t,n){"function"==typeof e?e(t):Shopify.onCartUpdate(t)})
},
...
Shopify.pollForCartShippingRatesForDestination=function(e,t,n)
{
	...
	var r=function()
	{
		...
		(
			...
			{
				dataType:"json",
				success:function(n,i,o){200===o.status?"function"==typeof t?t(n.shipping_rates,e):Shopify.onCartShippingRatesUpdate(n.shipping_rates,e):setTimeout(r,500)},
				error:n
			}
		)
	};
...
{
	jQuery.getJSON("/products/"+e+".js",function(e,n){"function"==typeof t?t(e):Shopify.onProduct(e)})
},
...
Shopify.changeItem=function(e,t,n)
{
	var r={
			...
			data:"quantity="+t+"&id="+e,
			dataType:"json",
			success:function(e){"function"==typeof n?n(e):Shopify.onCartUpdate(e)},
			error:function(e,t){Shopify.onError(e,t)}
		};
	jQuery.ajax(r)
},
...
Shopify.removeItem=function(e,t)
{
	var n={
			...
			dataType:"json",
			success:function(e){"function"==typeof t?t(e):Shopify.onCartUpdate(e)},
			error:function(e,t){Shopify.onError(e,t)}
	};
	jQuery.ajax(n)
},
...
Shopify.clear=function(e)
{
	var t={
			...
			data:"",
			dataType:"json",
			success:function(t){"function"==typeof e?e(t):Shopify.onCartUpdate(t)},
			error:function(e,t){Shopify.onError(e,t)}
		};
	jQuery.ajax(t)
},
...
Shopify.updateCartAttributes=function(e,t)
{
	...
	"object"==typeof e&&null!==e&&jQuery.each(
		e,function(e,t)
		{
...
jQuery.fn.jquery>="1.4"?Shopify.param=jQuery.param:(Shopify.param=function(e){
	...
	if(jQuery.isArray(e)||e.jquery)
		jQuery.each(e,function(){n(this.name,this.value)});else for(var r in e)Shopify.buildParams(r,e[r],n);return t.join("&").replace(/%20/g,"+")
},
...
Shopify.buildParams=function(e,t,n)
{
	jQuery.isArray(t)&&t.length?jQuery.each(t,function(t,r)
								...
								null!=t&&"object"==typeof t?Shopify.isEmptyObject(t)?n(e,""):jQuery.each(t,function(t,r){Shopify.buildParams(e+"["+t+"]",r,n)}):n(e,t)
},

Shopify.isEmptyObject=function(e){for(var t in e)return!1;return!0});